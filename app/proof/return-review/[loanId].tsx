        ...
        <ThemedView style={styles.container}>
          <Card style={styles.card}>
            ...
            <ThemedText style={{ color: mutedText }}>
              Cette étape est réservée à l’emprunteur après validation QR/code du retour.
            </ThemedText>
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: background }]} edges={['top']}>
      <ThemedView style={styles.container}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <Card style={styles.card}>
            <ThemedText type="title">Récapitulatif du retour</ThemedText>
            <ThemedText style={{ color: mutedText, fontSize: 12 }}>
              Vérifie les informations du prêteur avant validation finale du retour.
            </ThemedText>
          </Card>
          ...
          <Card style={styles.card}>
            ...
            <View style={styles.infoRow}>
              <ThemedText type="defaultSemiBold">État constaté</ThemedText>
              <ThemedText>{returnConditionLabel || 'Non renseigné'}</ThemedText>
            </View>
          </Card>
          ...
          {!alreadyAccepted ? (
            <Card style={styles.card}>
              ...
              <Button
                ...
                disabled={!acknowledged || !returnConditionLabel}
              />
            </Card>
          ) : null}
